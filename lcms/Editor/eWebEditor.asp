...
<link href="<%=LONE_EDITOR_STYLE%>" type="text/css" rel="stylesheet">
...
Sub Init()
	...
	aApplicationName = Application("Lone_Editor_ApplicationName")
	aApplicationUrl = Application("Lone_Editor_ApplicationUrl")
	...
	s_ApplicationName = "Lone_Editor" & n_Application
	...
	Application.Lock
	Application("Lone_Editor_ApplicationName") = aApplicationName
	Application("Lone_Editor_ApplicationUrl") = aApplicationUrl
