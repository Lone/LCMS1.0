...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="2">
  <form method="post" action="LCMS_ContentAdd_Save.asp" name="form1">
    <tr class="tdbg">
	  ...
	  <img border=0 src="../Editor/sysImage/rect.gif" width=18 style="cursor:hand;background-color:" id="s_bgcolor" onClick="SelectColor('bgcolor')" align="absmiddle" alt="选择标题颜色" />
   ...
   <tr class="tdbg"> 
	  ...
	  【<a href="javascript:ToAuthorName('匿名')"><font color='green'>匿名</font></a>】 
 	  </td>
    </tr>
  <% 
  if Menu_Type=0 then
   %>  	
    <tr class="tdbg">
      ...
      【<a href="javascript:ToCopyFrom('本站原创')"><font color='green'>本站原创</font></a>】【<a href="javascript:ToCopyFrom('转载')"><font color='green'>转载</font></a>】
    </td>
    </tr>
  <% 
...
%>	
 ...
 %>
  ...
  <% end if %>
    ...
    <td>选项：</td>
      <td colspan="2">
	  <input name="On_Top" type="checkbox" id="On_Top" value="1" /><label for="On_Top">置顶</label>
	  <input name="isBest" type="checkbox" id="isBest" value="1" /><label for="isBest">推荐</label>
	  <input name="Has_Image" type="checkbox" id="Has_Image" value="1" /><label for="Has_Image">图文</label>
	  <input name="Locked" type="checkbox" id="Locked" value="1" /><label for="Locked">锁定</label>
